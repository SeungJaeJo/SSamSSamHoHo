		...
		<header id="header" class="header position_ab">
			<div class="uh">
				<a href="${contextPath}" class="logo"> <img width="100"
					height="26" src="resources/images/logo.png">
				</a>
												...
												function makeKSList(data) {
													...
													$.each(data,
															function(index,obj) {
																...
																listHtml += "<span class='icon'>"
																+ obj.keyword[0]+ "</span>";
																listHtml += "<span class='itemsname'>"
																+ obj.keyword+ "</span>";
															});
					...
					<section class="chain_wrap col_lg9">
						<header class="title_wrap bdr_none bdr_bottom">
							<div id="searchSticky" class="title">
								<a
									href="https://www.joongang.co.kr/search/unifiedsearch?keyword=더불어민주당"
									class="btn_back"> <i class="ico_pre"></i><span
									class="visually_hidden">뒤로가기</span>
								</a>
							</div>
						</header>
						<ul class="story_list" id="cateList">
							...
							<script type="text/javascript">
								...
								// 사용자 입력 검색어 보내서 데이터 받아오기
								function get_searchKeyword(query) {
									$.ajax({
										url : "board/search",
										data : {
											query : query
								...
								function search_keyword(data) {
									...
									$.each(data,
											function(index, obj) {
												...
												listHtml += "<a href='${contextPath}/newsdetailForm.do?idx="
														 + obj.idx+ "'>"+ obj.title+ "</a></h2>";
												listHtml += "<p class='description sm_hidden'>"
														+ obj.summ_content+ "</p>";
												listHtml += "<div class='meta'>";
												listHtml += "<p class='source'>"
														+ obj.press+ "</p>";
												listHtml += "<p class='date'>"
														+ obj.date+ "</p>";
												listHtml += "</div></li>";
												});
						...
						<nav class="pagination_type02" aria-label="pagination">
							<ul>
								<li class="page_first"><a class="page_link btn_first"
									role="button" aria-label="처음 페이지">처음</a></li>
								<li class="page_prev"><a class="page_link btn_prev"
									role="button" aria-label="이전 페이지"><i class="ico_arrow_left"
										aria-hidden="true"></i></a></li>
								<li id="view_page_cnt"></li>
								<li class="page_next"><a class="page_link btn_next"
									role="button"><i class="ico_arrow_right"></i></a></li>
								<li class="page_last"><a class="page_link btn_last">마지막</a>
								</li>
							</ul>
						</nav>
					</section>
				...
				<div class="footer_info">
					<div class="footer_wrap">
						...
						<div class="logo sm_hidden md_hidden">
							<a href="https://www.joongang.co.kr" data-evnt-ctg="area:중앙|대통령실"
								data-evnt-act="move:A40 푸터 태그" data-evnt-lbl="footer logo"><span
